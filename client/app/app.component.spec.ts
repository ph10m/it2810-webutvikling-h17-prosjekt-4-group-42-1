...
describe('Component: App', () => {
  ...
  it('should display the navigation bar correctly for guests', () => {
    ...
    expect(de[0].nativeElement.textContent).toContain('Hearthstone Cards');
    expect(de[1].nativeElement.textContent).toContain('Cards');
    ...
    expect(de[1].attributes['routerLink']).toBe('/cards');
  ...
  it('should display the navigation bar correctly for logged users', () => {
    ...
    expect(de[0].nativeElement.textContent).toContain('Hearthstone Cards');
    expect(de[1].nativeElement.textContent).toContain('Cards')
    expect(de[2].nativeElement.textContent).toContain('Tester');
